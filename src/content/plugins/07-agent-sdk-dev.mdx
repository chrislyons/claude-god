...
- `carbon-acx/.claude/agents/`
- `hotbox/.claude/agents/`
- `orpheus-sdk/.claude/agents/`
- `wordbird/.claude/agents/`
- `helm/.claude/agents/`
- `undone/.claude/agents/`
...
```bash
cd ~/dev/carbon-acx/.claude/agents/data-analyzer
...
**carbon-acx: Data Pipeline Validator**
```bash
/new-sdk-app
...
**hotbox: Beat Pack Analyzer**
```bash
/new-sdk-app

Language: TypeScript
Purpose: Analyze beat pack structure and metadata
Tools: File system, JSON parsing, music metadata extraction
```

**orpheus-sdk: Audio Quality Checker**
```bash
/new-sdk-app
...
**wordbird: Dictionary Data Validator**
```bash
/new-sdk-app

Language: Rust (or TypeScript)
Purpose: Validate SQLite dictionary data integrity
