...
cp -r ~/dev/docs/archives/claude-architecture-migration-2026-01-02/user-claude-backup/* ~/.claude/

# Restore workspace .claude/ (if needed)
cp -r ~/dev/docs/archives/claude-architecture-migration-2026-01-02/workspace-claude-backup ~/dev/.claude

# Restore specific repo
cp -r ~/dev/docs/archives/claude-architecture-migration-2026-01-02/my-repo-claude-backup ~/dev/my-repo/.claude
```
